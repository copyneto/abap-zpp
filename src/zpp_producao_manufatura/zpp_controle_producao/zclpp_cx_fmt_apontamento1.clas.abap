class ZCLPP_CX_FMT_APONTAMENTO1 definition
  public
...
public section.
  ...
  data STANDARD type ZCLPP_EXCHANGE_FAULT_DATA1 read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZCLPP_EXCHANGE_FAULT_DATA1 optional
...
CLASS ZCLPP_CX_FMT_APONTAMENTO1 IMPLEMENTATION.
