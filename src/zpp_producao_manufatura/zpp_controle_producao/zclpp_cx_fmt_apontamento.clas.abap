class ZCLPP_CX_FMT_APONTAMENTO definition
  public
...
public section.
  ...
  data STANDARD type ZCLPP_EXCHANGE_FAULT_DATA read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZCLPP_EXCHANGE_FAULT_DATA optional
...
CLASS ZCLPP_CX_FMT_APONTAMENTO IMPLEMENTATION.
