...
"!<p><strong>Data:</strong> 21/03/2022</p>
CLASS zclpp_auth_zppwerks DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS gc_object TYPE xuobject VALUE 'ZPPWERKS'.
...
CLASS ZCLPP_AUTH_ZPPWERKS IMPLEMENTATION.
