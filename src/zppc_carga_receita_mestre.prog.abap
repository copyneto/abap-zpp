...
***********************************************************************
REPORT zppc_carga_receita_mestre.
...
CLASS lcl_report IMPLEMENTATION.
  ...
  METHOD processa_dados.
    ...
    LOOP AT gt_header ASSIGNING FIELD-SYMBOL(<fs_header>).
      ...
      bdc_fieldvalue( EXPORTING iv_fnam = 'BDC_CURSOR'                     iv_fval = 'RC271-PROFIDNETZ' ).
      ...
      bdc_fieldvalue( EXPORTING iv_fnam = 'PLKOD-PLNAL'                    iv_fval = '1').
